...
if __name__ == '__main__':
    ...
    do_custom_hf = False
    _custom_grid_file = os.path.join(r'C:\workspace\fiabilite\output', 'custom_hf_grid_cantilever.json')
    ...
    def print_planche_EFF(g_ot, sigma_func, xt, xt_eff):
        ...
        if hf_custom_points is not None:   # transfert5 T5-5 : grille custom si presente
    ...
    # PIRE-CAS sur la variable de position (semantique bi-niveau EC1). ACTIF sur ce cas
    # (variable 's') : sort un beta_proj "position toujours au pire" a comparer au beta
    # classique ET au beta du decouplage (s* fige en HF) -> test croise.
    ...
    # ACTIF sur ce cas (variable 's') : beta_proj a comparer au beta classique + decouplage.
