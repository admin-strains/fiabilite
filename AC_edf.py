...
if __name__ == '__main__':
    ...
    # --------------------------------------------------------------------------- #
    # PARAMETRES MESH                                                             #
    global_size     = 0.5    # global_physical_size (0.05 = rapide FORM, 0.007 = très fin)
    geo_min_approx  = 35     # geometric_approximation_min (4 = fin, 35 = grossier)
    ...
    def run_one_SOL(modelname, SOL, params_names, sensitivity=False, with_sens_dict=None): 
        ...
        for i in range (len(SOL)): 
            ...
            exec(open(r"C:\_workingDir\_SF\test flexion\InitSolver_edf.py").read(), globals()) #question pour Agnes : je ne suis pas sure que ca marche comme ca. 
