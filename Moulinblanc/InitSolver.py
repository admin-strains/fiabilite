...
static_params = [
    ...
    {"value": 1,        "table": "IPARM0","indices": [12]},          # WriteLog Pt Int
    ...
    {"value": 0.99,    "table": "DPARM0","indices": [10]},          # Cone border coef
    {"value": 1.0e-4,   "table": "DPARM0","indices": [11]},          # Tol. abs Alpha
    {"value": 5.0e-4,   "table": "DPARM0","indices": [12]},          # Tol. rel. |Pobj - Dobj|
...
cinematic_params = [
    ...
    {"value": 0.95,     "table": "DPARM0","indices": [20]},          # Cone border coef
    {"value": 1.0e-4,   "table": "DPARM0","indices": [21]},          # Tol. abs Alpha
    {"value": 1e-3,   "table": "DPARM0","indices": [22]},          # Tol. rel. |Pobj - Dobj|
    {"value": 1.0e-8,   "table": "DPARM0","indices": [23,24,25,26]}  # Tol. rel. Res
]
MKLPardiso_params = [     
