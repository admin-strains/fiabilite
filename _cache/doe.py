...
def save_doe_cache(fichier, n0, xt, yt, all_grad):
    """Ecrit un DOE complet."""
    try:
...
def load_doe_cache(fichier, n0, config_is_identical=True):
...
def save_doe_cache_incremental(fichier, n0, params_names, SOL, n_done):
