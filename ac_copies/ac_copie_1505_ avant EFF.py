...
if __name__ == '__main__':
    ...
    # --- Initialisation FORM ---
    def FORM_init(sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF, xt, yt, all_grad):
    ...
    def FORM_warm_start(modes, best_sps, sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF):
        if len(modes)>0:
            ...
            if g_val is not None and abs(g_val) > tol_warmstart:
                ...
                event, sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF, xt_ws, yt_ws, all_grad_ws = FORM_init(sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF, xt_ws, yt_ws, all_grad_ws)
    ...
    event, sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF, xt, yt, all_grad = FORM_init(sm_GEK, sm_GEPCK, g_ot_KRG, g_ot_GEK, g_ot_PCKRG, g_ot_GEPCK, g_ot_HF, xt, yt, all_grad)
