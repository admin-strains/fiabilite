...
if __name__ == '__main__':
    ...
    # PARAMETRES FORM                                                             #
    n_max_FORM = 50
    tol_FORM = 2e-1                                   # précision acceptée par FORM
    do_warm_start = False
    ...
    def print_visu(best_result, best_sp, xt, sm_GEK, g_ot_KRG, g_hf):
        import matplotlib.pyplot as plt
        from matplotlib.lines import Line2D
    ...
    """
    IMPORTANT : FORM FAIT DE CETTE MANIERE SUR GEK APPLIQUE AUTOMATIQUEMENT LE GRADIENT FD,
    JEN SUIS CASI SURE. IL FAUT UNE OT FUNCTION POUR DONNER LES DERIVEES; PAREIL POUR FORM SUR HF. 
    POUR LINSTANT ON LAISSE COMME CA CAR CA MARCHE BIEN; ENSUITE ; REVENIR AU NON GLOBAL AVEC CLAUDE STUDY
    GEK ET CONTINUER LE TAFF POUR VERIFIER LA PRISE EN COMPTE DES DERIVEES; LUI DEMANDER DE BIEN RELIRE
    LA DOC EVENTUELLEMENT. 
    SI LA DEF DE LEVENT CHANGE ALORS ET QUE TU CREE UN FORM_EVENT DIFFERENT POUR GEK NOUBLIE PAS DE 
    REMETTRE FORM EVENT DANS LE IF. 
    """
    sm_GEK = None #GEK
    g_ot_KRG = None #KRG
    ...
    if best_result is None:
        ...
        print_visu(best_result, best_sp, xt, sm_GEK, g_ot_KRG, run_HF)
