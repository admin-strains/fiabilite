import sys; print("LAUNCHER_EDF START", flush=True); sys.stdout.flush()
import os, sys
...
dll_dirs = [
    ...
    r'C:\workspace\front\01_3RDPARTY\03_meshgems\lib\Win10_64_VC17',
...
exec(open(r'C:\_workingDir\_SF\test flexion\AC_edf.py').read(), {'__name__': '__main__'})
