...
if __name__ == '__main__':
    ...
    do_PCK_B1 = True if modele == 'PCK_B1' else False  # branche1 Python — visu g=0 analytique
    ...
    def print_visu_pck_b1(N_doe=40, pce_degree=None, seed=42):
        ...
        # --- DOE en espace U ---
        X_doe = generate_doe(N_doe, marginals_u, method='lhs', seed=seed)  # (N_doe, n_var)
        ...
        # --- Grille fine en espace U (150x150 pour limiter les appels OT) ---
        ng = min(n_grid, 150)
        ...
        ax.contour(U1, U2, Z_ana,    levels=[0], colors='k',         linewidths=2.0)
        # Courbe g=0 PCK
        ax.contour(U1, U2, YMu_grid, levels=[0], colors='royalblue',
                   linewidths=2.0, linestyles='--')

        # Points du DOE
        ax.plot(X_doe[:, 0], X_doe[:, 1], 'r+', ms=8, mew=1.5)
        ax.plot(0, 0, 'g+', ms=12, mew=2)
