...
_etapes/figurer.py          (existe)  1 classe + 5 fn  398 l.
...
|---|---:|---:|---:|
| `AC3_pure_flexion.py` | 2 976 l. | **1 849 l.** | <= 250 |
| `AC3_moulinblanc.py` | 2 998 l. | **1 742 l.** | <= 250 |
| fonctions imbriquees | 58 / 60 | **42 / 42** | <= 8 |
| lignes de fonctions communes aux deux etudes | 1 975 | **997** | 0 |
